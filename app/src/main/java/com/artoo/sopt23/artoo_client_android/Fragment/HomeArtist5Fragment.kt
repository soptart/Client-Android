...
import kotlinx.android.synthetic.main.fragment_home_artist5.*


class HomeArtist5Fragment : Fragment() {

    lateinit var homeTodayRecyclerViewAdapter: HomeTodayRecyclerViewAdapter
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_home_artist5, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        snapHelper.attachToRecyclerView(rv_fragment_home_today_artist5_list)
    }
...
*/
        ...
        rv_fragment_home_today_artist5_list.adapter = homeTodayRecyclerViewAdapter
        rv_fragment_home_today_artist5_list.layoutManager = LinearLayoutManager(activity,LinearLayout.HORIZONTAL,false)
    }
}