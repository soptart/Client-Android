...
import kotlinx.android.synthetic.main.fragment_home_artist4.*


class HomeArtist4Fragment : Fragment() {

    lateinit var homeTodayRecyclerViewAdapter: HomeTodayRecyclerViewAdapter
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_home_artist4, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        snapHelper.attachToRecyclerView(rv_fragment_home_today_artist4_list)
    }
...
*/
        ...
        rv_fragment_home_today_artist4_list.adapter = homeTodayRecyclerViewAdapter
        rv_fragment_home_today_artist4_list.layoutManager = LinearLayoutManager(activity,LinearLayout.HORIZONTAL,false)
    }
}